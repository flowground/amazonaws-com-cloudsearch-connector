# ![LOGO](logo.png) Amazon CloudSearch MSP Connector

## Description

A generated MSP connector for the Amazon CloudSearch API (version 2013-01-01).
...
flowground :- Telekom iPaaS / amazonaws-com-cloudsearch-connector<br/>
